...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
			.body(ErrorResponse.of("METHOD_ARGUMENT_NOT_VALID", HttpStatus.BAD_REQUEST.value(), errorMessage));
	}
	...
	public ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
			.body(ErrorResponse.of("MISSING_REQUEST_PARAMETER", HttpStatus.BAD_REQUEST.value(), message));
	}
	...
	public ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
			.body(ErrorResponse.of("METHOD_ARGUMENT_TYPE_MISMATCH", HttpStatus.BAD_REQUEST.value(), errorMessage + " (Expected: " + requiredType + ")"));
	}
	...
	protected ResponseEntity<ErrorResponse> handleException(final Exception e) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
			.body(ErrorResponse.of("INTERNAL_SERVER_ERROR", HttpStatus.INTERNAL_SERVER_ERROR.value(), "서버 내부 오류입니다."));
	}
