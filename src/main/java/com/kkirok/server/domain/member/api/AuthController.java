...
public class AuthController implements AuthApi {
    ...
    public ResponseEntity<SuccessResponse<Void>> sendEmailVerificationCode(
        ...
        return ResponseEntity.ok().body(SuccessResponse.from(MemberSuccessCode.EMAIL_VERIFICATION_CODE_SENT));
    }
    ...
    public ResponseEntity<SuccessResponse<MemberLoginResponse>> localSignUp(
        ...
        writeRefreshTokenCookie(httpServletResponse, loginSuccessResponse.refreshToken());
        MemberLoginResponse response = toMemberLoginResponse(loginSuccessResponse);
        return ResponseEntity.ok().body(SuccessResponse.of(MemberSuccessCode.LOCAL_SIGN_UP_SUCCESS, response));
    }
    ...
    public ResponseEntity<SuccessResponse<MemberLoginResponse>> userLocalLogin(
        ...
        writeRefreshTokenCookie(httpServletResponse, loginSuccessResponse.refreshToken());
        MemberLoginResponse response = toMemberLoginResponse(loginSuccessResponse);
        return ResponseEntity.ok().body(SuccessResponse.of(MemberSuccessCode.LOCAL_LOGIN_SUCCESS, response));
    }
    ...
    public ResponseEntity<SuccessResponse<AccessTokenGenerateResponse>> issueAccessTokenUsingRefreshToken(
        ...
        return ResponseEntity.ok().body(SuccessResponse.of(MemberSuccessCode.ISSUE_ACCESS_TOKEN_USING_REFRESH_TOKEN, response));
    }
